...
#from utils import freeze_embeds, assert_all_frozen, freeze_params 
...
def main():
    ...
    if isinstance(tokenizer, (MBartTokenizer, MBartTokenizerFast, MBart50Tokenizer)):
